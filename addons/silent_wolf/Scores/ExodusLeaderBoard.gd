...
func merge_scores_with_local_scores(scores, local_scores, max_scores=100):
	if local_scores:
...
func add_item(player_name, score):
	...
	$"Board/HighScores/MarginContainer/ScrollContainer/ScoreItemContainer".add_child(item)
...
func clear_leaderboard():
	var score_item_container = $"Board/HighScores/MarginContainer/ScrollContainer/ScoreItemContainer"
...
func _on_CloseButton_pressed():
	...
	SWLogger.info("Closing SilentWolf leaderboard, switching to scene: " + str(main_menu))
	#global.reset()

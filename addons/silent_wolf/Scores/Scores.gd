...
func get_high_scores(maximum=100, ldboard_name="main", period_offset=0):
...
func get_scores_by_player(player_name, maximum=100, ldboard_name="main", period_offset=0):
...
func get_top_score_by_player(player_name, maximum=100, ldboard_name="main", period_offset=0):
